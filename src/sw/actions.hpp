...
{
    explicit RangeAttack(uint32_t range, uint32_t agility) : range{range}, agility{agility} {}
...
{
    explicit MeleeAttack(uint32_t strength) : strength{strength} {}
