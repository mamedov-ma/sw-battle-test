...
{
public:
    explicit Unit(UnitRepository& unitRepo, uint32_t id, uint32_t hp, pos_t pos) : unitRepo{unitRepo}, id{id}, hp{hp}, pos{pos} {}
...
protected:
    ...
    uint32_t hp;
    pos_t pos;
    std::string name = "unit"s;
};

class Warrior final : public Unit, public actions::MeleeAttack
{
public:
    explicit Warrior(UnitRepository& unitRepo, uint32_t id, uint32_t hp, pos_t pos, uint32_t strength) : Unit{unitRepo, id, hp, pos}, actions::MeleeAttack{strength} {}
...
class Archer final : public Unit, public actions::MeleeAttack, actions::RangeAttack
{
public:
    explicit Archer(UnitRepository& unitRepo, uint32_t id, uint32_t hp, pos_t pos, uint32_t strength, uint32_t range, uint32_t agility) : Unit{unitRepo, id, hp, pos}, actions::MeleeAttack{strength}, RangeAttack{range, agility} {}
